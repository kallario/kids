...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post turmas_url, params: { turma: { descricao: @turma.descricao, idade_final: @turma.idade_final, idade_inicial: @turma.idade_inicial, nome_turma: @turma.nome_turma } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { descricao: @turma.descricao, idade_final: @turma.idade_final, idade_inicial: @turma.idade_inicial, nome_turma: @turma.nome_turma } }
