...
class FamiliasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create familia" do
    assert_difference('Familia.count') do
      post familias_url, params: { familia: { codigo: @familia.codigo, sobrenome: @familia.sobrenome, telefone: @familia.telefone } }
    end
  ...
  test "should update familia" do
    patch familia_url(@familia), params: { familia: { codigo: @familia.codigo, sobrenome: @familia.sobrenome, telefone: @familia.telefone } }
