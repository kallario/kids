...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { data_evento: @evento.data_evento, pessoa_id: @evento.pessoa_id, responsavel_id: @evento.responsavel_id, tipo_evento: @evento.tipo_evento } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { data_evento: @evento.data_evento, pessoa_id: @evento.pessoa_id, responsavel_id: @evento.responsavel_id, tipo_evento: @evento.tipo_evento } }
