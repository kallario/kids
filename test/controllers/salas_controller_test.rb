...
class SalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post salas_url, params: { sala: { capacidade: @sala.capacidade, descricao: @sala.descricao, nome_sala: @sala.nome_sala, turma_ate: @sala.turma_ate, turma_de: @sala.turma_de } }
    end
  ...
  test "should update sala" do
    patch sala_url(@sala), params: { sala: { capacidade: @sala.capacidade, descricao: @sala.descricao, nome_sala: @sala.nome_sala, turma_ate: @sala.turma_ate, turma_de: @sala.turma_de } }
